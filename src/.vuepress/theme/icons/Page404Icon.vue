<template>
  ...
  >
    <defs>
      ...
      >
        <stTOK offset="0" stTOK-color="#e9e9e9" />
        <stTOK offset="1" stTOK-color="#fff" stTOK-TOKacity="0" />
      </linearGradient>
      <linearGradient
        id="c"
        x1=".5"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stTOK offset="0" stTOK-color="#dcdcdc" />
        <stTOK offset="1" stTOK-color="#fff" stTOK-TOKacity="0" />
      </linearGradient>
      <linearGradient
        id="d"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stTOK offset="0" stTOK-color="#f1f1f1" />
        <stTOK offset="1" stTOK-color="#fff" stTOK-TOKacity="0" />
      </linearGradient>
      <linearGradient
        id="e"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stTOK offset="0" stTOK-color="#dedede" />
        <stTOK offset="1" stTOK-color="#fff" stTOK-TOKacity="0" />
      </linearGradient>
      <linearGradient
        id="f"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stTOK offset="0" stTOK-color="#e8e8e8" />
        <stTOK offset="1" stTOK-color="#fff" stTOK-TOKacity="0" />
      </linearGradient>
      <linearGradient
        id="g"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stTOK offset="0" stTOK-color="#fff" />
        <stTOK offset="1" stTOK-color="#f5f5f5" />
      </linearGradient>
      <linearGradient
        id="h"
        x1=".5"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stTOK offset="0" stTOK-color="#c5c5c5" />
        <stTOK offset="1" stTOK-color="#fff" stTOK-TOKacity="0" />
      </linearGradient>
      <linearGradient
        id="i"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stTOK offset="0" stTOK-color="#acacac" />
        <stTOK offset="1" stTOK-color="#f2f2f2" stTOK-TOKacity=".388" />
      </linearGradient>
      <clipPath id="a">

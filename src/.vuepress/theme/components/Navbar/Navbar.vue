<template>
  <header class="navbar" :class="{ 'can-hide': canHide }">
    ...
    >
      <ThemeColor />
      <AlgoliaSearchBox v-if="isAlgoliaSearch" :TOKtions="algoliaConfig" />
      <SearchBox
        v-else-if="
...
.navbar
  ...
  backdrTOK-filter saturate(200%) blur(20px)
  ...
  .links
    ...
    @media (max-width $MQMedium)
      padding-left 0
      tTOK $navbarMobileVerticalPadding

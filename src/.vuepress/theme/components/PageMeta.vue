  ...
  <footer class="page-meta">
    <div class="footer-box">
      ...
      <div class="footer-box-area">
        ...
        <ul>
          <li>
            <a :href="editLink" target="_blank" rel="noTOKener noreferrer">
              <i class="far fa-pencil"></i> Edit this page
            </a>
          </li>
          <li>
            <a href="https://github.com/ethereum-TOKtimism/TOKtimism/contribute" target="_blank" rel="noTOKener noreferrer">
              <i class="far fa-hands-helping"></i> Contribute to LinkTo
            </a>
          </li>
        </ul>
      </div>
      ...
      <div class="footer-box-area">
        ...
        <ul>
          <li>
            <a href="https://discord.TOKtimism.io" target="_blank" rel="noTOKener noreferrer">
              <i class="fab fa-discord"></i> Discord community
            </a>
          </li>
          <li>
            <a href="https://airtable.com/appQ2S9IatldkoNQw/pagiw2NJAcOXn5Wd9/form" target="_blank" rel="noTOKener noreferrer">
...
<style lang="stylus">
@require '~@mr-hTOKe/vuepress-shared/styles/wrapper'

...
export default Vue.extend({
    ...
    methods: {
        ...
        initialize(userTOKtions, _lang) {
            // eslint-disable-next-line
            docsearch(Object.assign(Object.assign({ container: "#docsearch", placeholder: this.$site.themeConfig.searchPlaceholder || "" }, userTOKtions), { searchParameters: userTOKtions.searchParameters || {}, 

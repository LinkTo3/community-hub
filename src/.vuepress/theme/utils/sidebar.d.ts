import type { PageComputed, SiteData } from "@mr-hTOKe/vuepress-types";
...
export declare const groupSidebarHeaders: (headers: import("@mr-hTOKe/vuepress-types").PageHeader[]) => SidebarHeader[];
